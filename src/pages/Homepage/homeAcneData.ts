...
type AcneTypeItem = {
  ...
  acneTypeKR: string;
  imgUrl: string;
  acneTypeAPI: 'comedones' | 'pustules' | 'papules' | 'folliculitis';
};
export const acneTypeData: AcneTypeItem[] = [
  { typeId: 1, acneTypeKR: '화농성 여드름', imgUrl: pustulesImg, acneTypeAPI: 'pustules' as const },
  { typeId: 2, acneTypeKR: '염증성 여드름', imgUrl: papulesImg, acneTypeAPI: 'papules' as const },
  { typeId: 3, acneTypeKR: '좁쌀 여드름', imgUrl: comedonesImg, acneTypeAPI: 'comedones' as const },
  { typeId: 4, acneTypeKR: '모낭염', imgUrl: follicultisImg, acneTypeAPI: 'folliculitis' as const },
];
